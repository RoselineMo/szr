      ...
      <div className="optional mb-12">
        ...
        {userDomain && (
          <input
            ...
            className="domain absolute mt-12 md:w-40 w:60 h-12 pl-3 pb-1 border border-gray-300 rounded-md lowercase font-light focus:outline-gray-600 text-gray-400 md:text-sm text-xs"
          />
        )}
      </div>
    </div>
