      ...
      <div className="optional mb-12">
        ...
        <div className="flex justify-start gap-0 mb-2 w-80 md:w-96 relative">
          <select
            ...
            className="domain w-56 md:w-40 h-12 pl-3 pb-1 border border-gray-300 lowercase font-medi focus:outline-gray-600 text-gray-400 md:text-sm text-xs"
          >
          ...
          <input
            ...
            className="custom-text absolute w-40 md:w-56 h-12 pl-3 pb-1 border border-gray-300 caret-green-800 focus:outline-green-800 md:text-sm text-xs"
          />
        </div>
        {userDomain && (
          <input
