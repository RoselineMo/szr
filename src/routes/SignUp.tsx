    ...
    <div className="wrapper md:mt-36 mt-32  w-full grid-cols-3 place-items-center">
      <div className="form">
        ...
        <form action="submit grid">
          ...
          <button className="w-80 h-14 text-sm uppercase text-white font-medi bg-green-900 border rounded-xl hover:bg-green-950 hover:text-white hover:border-green-950 hover:border-2 mb-6">
            Continue
          </button>
